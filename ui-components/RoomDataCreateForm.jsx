...
import { createRoomData } from "./graphql/mutations";
...
export default function RoomDataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createRoomData.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "RoomDataCreateForm")}
      {...rest}
    >
      <SelectField
        label="Template"
